...
(
    ...
    (
        ...
        // AXI4-lite Signals
        .m_axi_IP1_awaddr           (m_axi_drm_awaddr           ),
        .m_axi_IP1_awvalid          (m_axi_drm_awvalid          ),
        .m_axi_IP1_awready          (m_axi_drm_awready          ),
        .m_axi_IP1_wdata            (m_axi_drm_wdata            ),
        .m_axi_IP1_wvalid           (m_axi_drm_wvalid           ),
        .m_axi_IP1_wstrb            (m_axi_drm_wstrb            ),
        .m_axi_IP1_wready           (m_axi_drm_wready           ),
        .m_axi_IP1_araddr           (m_axi_drm_araddr           ),
        .m_axi_IP1_arvalid          (m_axi_drm_arvalid          ),
        .m_axi_IP1_arready          (m_axi_drm_arready          ),
        .m_axi_IP1_rdata            (m_axi_drm_rdata            ),
        .m_axi_IP1_rvalid           (m_axi_drm_rvalid           ),
        .m_axi_IP1_rready           (m_axi_drm_rready           ),
        .m_axi_IP1_rresp            (m_axi_drm_rresp            ),
        .m_axi_IP1_bvalid           (m_axi_drm_bvalid           ),
        .m_axi_IP1_bready           (m_axi_drm_bready           ),
        .m_axi_IP1_bresp            (m_axi_drm_bresp            ),
        .m_axi_IP2_awaddr           (m_axi_userip_awaddr        ),
        .m_axi_IP2_awvalid          (m_axi_userip_awvalid       ),
        .m_axi_IP2_awready          (m_axi_userip_awready       ),
        .m_axi_IP2_wdata            (m_axi_userip_wdata         ),
        .m_axi_IP2_wvalid           (m_axi_userip_wvalid        ),
        .m_axi_IP2_wstrb            (m_axi_userip_wstrb         ),
        .m_axi_IP2_wready           (m_axi_userip_wready        ),
        .m_axi_IP2_araddr           (m_axi_userip_araddr        ),
        .m_axi_IP2_arvalid          (m_axi_userip_arvalid       ),
        .m_axi_IP2_arready          (m_axi_userip_arready       ),
        .m_axi_IP2_rdata            (m_axi_userip_rdata         ),
        .m_axi_IP2_rvalid           (m_axi_userip_rvalid        ),
        .m_axi_IP2_rready           (m_axi_userip_rready        ),
        .m_axi_IP2_rresp            (m_axi_userip_rresp         ),
        .m_axi_IP2_bvalid           (m_axi_userip_bvalid        ),
        .m_axi_IP2_bready           (m_axi_userip_bready        ),
        .m_axi_IP2_bresp            (m_axi_userip_bresp         )
    );
