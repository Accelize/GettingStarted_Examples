...
library DRM_0X1003000E00040001_LIBRARY;
use DRM_0X1003000E00040001_LIBRARY.all;

use WORK.drm_activator_0x1003000e00040001_sim_pkg.all;


entity top_drm_activator_0x1003000e00040001 is
port (
...
end entity top_drm_activator_0x1003000e00040001;

architecture top_drm_activator_0x1003000e00040001_rtl of top_drm_activator_0x1003000e00040001 is
...
begin
  ...
  WITH_BFM: if USE_BFM=TRUE generate
    ...
    drm_controller_bfm_inst: entity DRM_0X1003000E00040001_LIBRARY.DRM_CONTROLLER_BFM
      generic map (
  ...
  drm_ip_activator_0x1003000e00040001_inst: entity DRM_0X1003000E00040001_LIBRARY.drm_ip_activator_0x1003000e00040001
  port map (
    DRM_ACLK              => drm_aclk,
    DRM_ARSTN             => drm_arstn,
...
end architecture top_drm_activator_0x1003000e00040001_rtl;
-- pragma translate_on
