...
entity DRM_IP_ACTIVATOR_0x1003000E00040001 is
  port (
...
end entity DRM_IP_ACTIVATOR_0x1003000E00040001;

architecture DRM_IP_ACTIVATOR_0x1003000E00040001_RTL of DRM_IP_ACTIVATOR_0x1003000E00040001 is

  constant C_DRM_IP_ACTIVATOR_0x1003000E00040001_DRM_VERSION : std_logic_vector(23 downto 0) := x"040001";

begin

  -- drm activator version check
  assert C_DRM_IP_ACTIVATOR_0x1003000E00040001_DRM_VERSION(23 downto 8) = C_DRM_SLAVE_DRM_VERSION(23 downto 8)
    report "The version of the DRM_IP_ACTIVATOR_0x1003000E00040001 is not supported by the DRM HDK." severity failure;
  ...
  DRM_ACTIVATOR_INSTANCE : DRM_ACTIVATOR
    ...
    port map (
      ...
      DEMO_MODE,
      ACTIVATION_CODE,
      x"675EC6D5E748B5E5302ADF8350E28D76"
    );

end architecture DRM_IP_ACTIVATOR_0x1003000E00040001_RTL;
