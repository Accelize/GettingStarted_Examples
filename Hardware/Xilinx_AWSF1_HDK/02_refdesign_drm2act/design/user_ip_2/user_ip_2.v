...
`timescale 1 ns / 1 ps
`include "drm_activation_code_package_0x1003000e00040001.v"
module user_ip_2
(
  // System Signals
  input  wire                        clk                        ,
  ...
  output wire                        uip_to_drm_tvalid
    ...
    assign usage_unit_event     = rst_n && m00_axi_arvalid && m00_axi_arready;  
            ...
            case (s_read_state_machine)
                FSMIDLE: begin                              
                    ...
                    if ( m00_axi_arvalid == 1'b1 ) begin
                        ...
                        m00_axi_rvalid              <= 1'b1;
                        m00_axi_rdata               <=  (m00_axi_araddr[15:0]==16'h00)?{{29{1'b0}}, 1'b1, s_activation_code_ready, s_activated}:
    ...
    drm_ip_activator_0x1003000e00040001_axi4st drm_ip_activator_0x1003000e00040001_axi4st_inst (
      .drm_aclk              ( clk                     ),
      .drm_arstn             ( rst_n                   ),       
