...
assign drm_to_uip1_tdata[31:6]  = 26'b0;
assign drm_to_uip1_tdata[4]     = drm_bus_master_o_cyc;
assign drm_to_uip1_tdata[3:2]   = drm_bus_master_o_adr;
assign drm_to_uip1_tdata[1]     = drm_bus_master_o_we;
assign drm_to_uip1_tdata[0]     = drm_bus_master_o_dat;
...
drm_controller_ip #(
  ...
  .drm_bus_master_o_cs_1            ( drm_to_uip1_tdata[5]      ),  
  .drm_bus_master_i_dat_1           ( uip1_to_drm_tdata[0]      ),
  .drm_bus_master_i_ack_1           ( uip1_to_drm_tdata[3]      ),
  .drm_bus_master_i_intr_1          ( uip1_to_drm_tdata[2]      ),
  .drm_bus_master_i_sta_1           ( uip1_to_drm_tdata[1]      ),
