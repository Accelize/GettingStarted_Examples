...
read_vhdl [ glob $ENC_SRC_DIR/*.vhdl ] -library drm_library
read_vhdl [ glob $ENC_SRC_DIR/*.vhd ] -library drm_library
read_verilog [glob $ENC_SRC_DIR/*.v]
read_verilog -sv [glob $ENC_SRC_DIR/*.?v]
read_ip $ENC_SRC_DIR/axi_crossbar_1s3m/axi_crossbar_1s3m.xci
