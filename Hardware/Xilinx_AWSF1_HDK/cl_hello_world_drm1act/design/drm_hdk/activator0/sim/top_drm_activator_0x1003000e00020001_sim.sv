...
import drm_activator_0x1003000e00020001_sim_pkg::*;


module top_drm_activator_0x1003000e00020001 (
  ...
  generate if (drm_activator_0x1003000e00020001_sim_pkg::USE_BFM == 1) begin
    ...
    DRM_CONTROLLER_BFM #(
      .LICENSE_FILE           (drm_activator_0x1003000e00020001_sim_pkg::DRM_LICENSE_FILE),
      .LICENSE_TIMER          (""),
      .ENABLE_MESSAGE_DISPLAY (drm_activator_0x1003000e00020001_sim_pkg::ENABLE_DRM_MESSAGE)
  ...
  drm_ip_activator_0x1003000e00020001 drm_ip_activator_0x1003000e00020001_inst (
    .DRM_ACLK              (drm_aclk),
    .DRM_ARSTN             (drm_arstn),
