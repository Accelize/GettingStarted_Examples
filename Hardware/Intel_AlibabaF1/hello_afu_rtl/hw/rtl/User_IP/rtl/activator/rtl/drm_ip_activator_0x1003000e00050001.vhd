...
entity DRM_IP_ACTIVATOR_0x1003000E00050001 is
  port (
...
end entity DRM_IP_ACTIVATOR_0x1003000E00050001;

architecture DRM_IP_ACTIVATOR_0x1003000E00050001_RTL of DRM_IP_ACTIVATOR_0x1003000E00050001 is

  constant C_DRM_IP_ACTIVATOR_0x1003000E00050001_DRM_VERSION : std_logic_vector(23 downto 0) := x"030202";

begin

  -- drm activator version check
  assert C_DRM_IP_ACTIVATOR_0x1003000E00050001_DRM_VERSION(23 downto 8) = C_DRM_SLAVE_DRM_VERSION(23 downto 8)
    report "The version of the DRM_IP_ACTIVATOR_0x1003000E00050001 is not supported by the DRM HDK." severity failure;
  ...
  DRM_ACTIVATOR_INSTANCE : DRM_ACTIVATOR
    ...
    port map (
      ...
      DEMO_MODE,
      ACTIVATION_CODE,
      x"88145858FF33CA8A23D4D00D86B2FE1B"
    );

end architecture DRM_IP_ACTIVATOR_0x1003000E00050001_RTL;
