...
int main(int argc, char** argv)
{
    ...
    int size = DATA_SIZE;
    std::string binary_file ("/lib/firmware/xilinx/accelize-k26-drmdemo-firmware/accelize-k26-drmdemo-firmware.xclbin");
...
//ACCELIZE DRMLIB CODE AREA START      
    ...
    DrmManager *pDrmManag = new DrmManager(
        std::string("/etc/xilinx_appstore/xlz-k26-drmdemo/conf.json"),
