...
entity drm_ip_controller is
  generic (
    ...
    READ_ONLY_MAILBOX_DATA  : std_logic_vector := x"" -- read only mailbox data (left is the first read only mailbox word)
  );
  port (
    ...
    DRM_BUS_MASTER_O_CS_4         : out std_logic;
    DRM_BUS_MASTER_I_ACK_4        : in  std_logic;
    DRM_BUS_MASTER_I_STA_4        : in  std_logic;
    DRM_BUS_MASTER_I_INTR_4       : in  std_logic;
    DRM_BUS_MASTER_I_DAT_4        : in  std_logic_vector(0 downto 0);
    -- DRM Bus master ip 5 socket
    DRM_BUS_MASTER_O_CS_5         : out std_logic;
    DRM_BUS_MASTER_I_ACK_5        : in  std_logic;
    DRM_BUS_MASTER_I_STA_5        : in  std_logic;
    DRM_BUS_MASTER_I_INTR_5       : in  std_logic;
    DRM_BUS_MASTER_I_DAT_5        : in  std_logic_vector(0 downto 0);
    -- DRM Bus master ip 6 socket
    DRM_BUS_MASTER_O_CS_6         : out std_logic;
    DRM_BUS_MASTER_I_ACK_6        : in  std_logic;
    DRM_BUS_MASTER_I_STA_6        : in  std_logic;
    DRM_BUS_MASTER_I_INTR_6       : in  std_logic;
    DRM_BUS_MASTER_I_DAT_6        : in  std_logic_vector(0 downto 0);
    -- DRM Bus master ip 7 socket
    DRM_BUS_MASTER_O_CS_7         : out std_logic;
    DRM_BUS_MASTER_I_ACK_7        : in  std_logic;
    DRM_BUS_MASTER_I_STA_7        : in  std_logic;
    DRM_BUS_MASTER_I_INTR_7       : in  std_logic;
    DRM_BUS_MASTER_I_DAT_7        : in  std_logic_vector(0 downto 0);
    -- DRM Bus master ip 8 socket
    DRM_BUS_MASTER_O_CS_8         : out std_logic;
    DRM_BUS_MASTER_I_ACK_8        : in  std_logic;
    DRM_BUS_MASTER_I_STA_8        : in  std_logic;
    DRM_BUS_MASTER_I_INTR_8       : in  std_logic;
    DRM_BUS_MASTER_I_DAT_8        : in  std_logic_vector(0 downto 0);
    -- DRM Bus master ip 9 socket
    DRM_BUS_MASTER_O_CS_9         : out std_logic;
    DRM_BUS_MASTER_I_ACK_9        : in  std_logic;
    DRM_BUS_MASTER_I_STA_9        : in  std_logic;
    DRM_BUS_MASTER_I_INTR_9       : in  std_logic;
    DRM_BUS_MASTER_I_DAT_9        : in  std_logic_vector(0 downto 0)
  );
...
architecture drm_ip_controller_RTL of drm_ip_controller is
  ...
  constant C_DRM_IP_ADR_4 : std_logic_vector(C_DRM_BUS_ADR_SIZE-C_DRM_BUS_ADR_LSB_SIZE-1 downto 0) := std_logic_vector(to_unsigned(5, C_DRM_BUS_ADR_SIZE-C_DRM_BUS_ADR_LSB_SIZE));
  constant C_DRM_IP_ADR_5 : std_logic_vector(C_DRM_BUS_ADR_SIZE-C_DRM_BUS_ADR_LSB_SIZE-1 downto 0) := std_logic_vector(to_unsigned(6, C_DRM_BUS_ADR_SIZE-C_DRM_BUS_ADR_LSB_SIZE));
  constant C_DRM_IP_ADR_6 : std_logic_vector(C_DRM_BUS_ADR_SIZE-C_DRM_BUS_ADR_LSB_SIZE-1 downto 0) := std_logic_vector(to_unsigned(7, C_DRM_BUS_ADR_SIZE-C_DRM_BUS_ADR_LSB_SIZE));
  constant C_DRM_IP_ADR_7 : std_logic_vector(C_DRM_BUS_ADR_SIZE-C_DRM_BUS_ADR_LSB_SIZE-1 downto 0) := std_logic_vector(to_unsigned(8, C_DRM_BUS_ADR_SIZE-C_DRM_BUS_ADR_LSB_SIZE));
  constant C_DRM_IP_ADR_8 : std_logic_vector(C_DRM_BUS_ADR_SIZE-C_DRM_BUS_ADR_LSB_SIZE-1 downto 0) := std_logic_vector(to_unsigned(9, C_DRM_BUS_ADR_SIZE-C_DRM_BUS_ADR_LSB_SIZE));
  constant C_DRM_IP_ADR_9 : std_logic_vector(C_DRM_BUS_ADR_SIZE-C_DRM_BUS_ADR_LSB_SIZE-1 downto 0) := std_logic_vector(to_unsigned(10, C_DRM_BUS_ADR_SIZE-C_DRM_BUS_ADR_LSB_SIZE));
  ...
  signal S_DRM_BUS_MASTER_I_STA  : std_logic_vector(9 downto 0);
...
begin
  ...
  S_DRM_BUS_MASTER_I_STA(4) <= DRM_BUS_MASTER_I_STA_4;
  S_DRM_BUS_MASTER_I_STA(5) <= DRM_BUS_MASTER_I_STA_5;
  S_DRM_BUS_MASTER_I_STA(6) <= DRM_BUS_MASTER_I_STA_6;
  S_DRM_BUS_MASTER_I_STA(7) <= DRM_BUS_MASTER_I_STA_7;
  S_DRM_BUS_MASTER_I_STA(8) <= DRM_BUS_MASTER_I_STA_8;
  S_DRM_BUS_MASTER_I_STA(9) <= DRM_BUS_MASTER_I_STA_9;
  ...
  begin
    ...
    elsif S_SPLITTED_DRM_BUS_MASTER_O_ADR = C_DRM_IP_ADR_4 then
      S_SLAVE_SELECTOR <= SELECT_IP_4;
    elsif S_SPLITTED_DRM_BUS_MASTER_O_ADR = C_DRM_IP_ADR_5 then
      S_SLAVE_SELECTOR <= SELECT_IP_5;
    elsif S_SPLITTED_DRM_BUS_MASTER_O_ADR = C_DRM_IP_ADR_6 then
      S_SLAVE_SELECTOR <= SELECT_IP_6;
    elsif S_SPLITTED_DRM_BUS_MASTER_O_ADR = C_DRM_IP_ADR_7 then
      S_SLAVE_SELECTOR <= SELECT_IP_7;
    elsif S_SPLITTED_DRM_BUS_MASTER_O_ADR = C_DRM_IP_ADR_8 then
      S_SLAVE_SELECTOR <= SELECT_IP_8;
    elsif S_SPLITTED_DRM_BUS_MASTER_O_ADR = C_DRM_IP_ADR_9 then
      S_SLAVE_SELECTOR <= SELECT_IP_9;
    else
  ...
  begin
    if S_DRM_ARSTN = '0' then
      ...
      case S_SLAVE_SELECTOR is
        ...
        when SELECT_IP_4 =>
          S_DRM_BUS_MASTER_I_DAT <= DRM_BUS_MASTER_I_DAT_4;
          S_DRM_BUS_MASTER_I_ACK <= DRM_BUS_MASTER_I_ACK_4;
          S_DRM_BUS_MASTER_I_INTR <= DRM_BUS_MASTER_I_INTR_4;
        when SELECT_IP_5 =>
          S_DRM_BUS_MASTER_I_DAT <= DRM_BUS_MASTER_I_DAT_5;
          S_DRM_BUS_MASTER_I_ACK <= DRM_BUS_MASTER_I_ACK_5;
          S_DRM_BUS_MASTER_I_INTR <= DRM_BUS_MASTER_I_INTR_5;
        when SELECT_IP_6 =>
          S_DRM_BUS_MASTER_I_DAT <= DRM_BUS_MASTER_I_DAT_6;
          S_DRM_BUS_MASTER_I_ACK <= DRM_BUS_MASTER_I_ACK_6;
          S_DRM_BUS_MASTER_I_INTR <= DRM_BUS_MASTER_I_INTR_6;
        when SELECT_IP_7 =>
          S_DRM_BUS_MASTER_I_DAT <= DRM_BUS_MASTER_I_DAT_7;
          S_DRM_BUS_MASTER_I_ACK <= DRM_BUS_MASTER_I_ACK_7;
          S_DRM_BUS_MASTER_I_INTR <= DRM_BUS_MASTER_I_INTR_7;
        when SELECT_IP_8 =>
          S_DRM_BUS_MASTER_I_DAT <= DRM_BUS_MASTER_I_DAT_8;
          S_DRM_BUS_MASTER_I_ACK <= DRM_BUS_MASTER_I_ACK_8;
          S_DRM_BUS_MASTER_I_INTR <= DRM_BUS_MASTER_I_INTR_8;
        when SELECT_IP_9 =>
          S_DRM_BUS_MASTER_I_DAT <= DRM_BUS_MASTER_I_DAT_9;
          S_DRM_BUS_MASTER_I_ACK <= DRM_BUS_MASTER_I_ACK_9;
          S_DRM_BUS_MASTER_I_INTR <= DRM_BUS_MASTER_I_INTR_9;
        when others =>
          S_DRM_BUS_MASTER_I_DAT <= (others => '0');
          S_DRM_BUS_MASTER_I_ACK <= '0';
          S_DRM_BUS_MASTER_I_INTR <= '0';
  ...
  begin
    if S_DRM_ARSTN = '0' then
      ...
      DRM_BUS_MASTER_O_CS_4 <= '0';
      DRM_BUS_MASTER_O_CS_5 <= '0';
      DRM_BUS_MASTER_O_CS_6 <= '0';
      DRM_BUS_MASTER_O_CS_7 <= '0';
      DRM_BUS_MASTER_O_CS_8 <= '0';
      DRM_BUS_MASTER_O_CS_9 <= '0';
    elsif rising_edge(S_DRM_ACLK) then
      S_DRM_BUS_SLAVE_I_CS <= '0';
      S_DRM_BUS_SLAVE_I_CYC <= '0';
      S_DRM_BUS_SLAVE_I_WE <= '0';
      ...
      case S_SLAVE_SELECTOR is
        ...
        when SELECT_IP_3 =>
          ...
          DRM_BUS_MASTER_O_DAT <= S_DRM_BUS_MASTER_O_DAT;
        when SELECT_IP_4 =>
          DRM_BUS_MASTER_O_CS_4 <= '1';
          DRM_BUS_MASTER_O_CYC <= S_DRM_BUS_MASTER_O_CYC;
          DRM_BUS_MASTER_O_WE <= S_DRM_BUS_MASTER_O_WE;
          DRM_BUS_MASTER_O_ADR <= S_DRM_BUS_MASTER_O_ADR(C_DRM_BUS_ADR_LSB_SIZE-1 downto 0);
          DRM_BUS_MASTER_O_DAT <= S_DRM_BUS_MASTER_O_DAT;
        when SELECT_IP_5 =>
          DRM_BUS_MASTER_O_CS_5 <= '1';
          DRM_BUS_MASTER_O_CYC <= S_DRM_BUS_MASTER_O_CYC;
          DRM_BUS_MASTER_O_WE <= S_DRM_BUS_MASTER_O_WE;
          DRM_BUS_MASTER_O_ADR <= S_DRM_BUS_MASTER_O_ADR(C_DRM_BUS_ADR_LSB_SIZE-1 downto 0);
          DRM_BUS_MASTER_O_DAT <= S_DRM_BUS_MASTER_O_DAT;
        when SELECT_IP_6 =>
          DRM_BUS_MASTER_O_CS_6 <= '1';
          DRM_BUS_MASTER_O_CYC <= S_DRM_BUS_MASTER_O_CYC;
          DRM_BUS_MASTER_O_WE <= S_DRM_BUS_MASTER_O_WE;
          DRM_BUS_MASTER_O_ADR <= S_DRM_BUS_MASTER_O_ADR(C_DRM_BUS_ADR_LSB_SIZE-1 downto 0);
          DRM_BUS_MASTER_O_DAT <= S_DRM_BUS_MASTER_O_DAT;
        when SELECT_IP_7 =>
          DRM_BUS_MASTER_O_CS_7 <= '1';
          DRM_BUS_MASTER_O_CYC <= S_DRM_BUS_MASTER_O_CYC;
          DRM_BUS_MASTER_O_WE <= S_DRM_BUS_MASTER_O_WE;
          DRM_BUS_MASTER_O_ADR <= S_DRM_BUS_MASTER_O_ADR(C_DRM_BUS_ADR_LSB_SIZE-1 downto 0);
          DRM_BUS_MASTER_O_DAT <= S_DRM_BUS_MASTER_O_DAT;
        when SELECT_IP_8 =>
          DRM_BUS_MASTER_O_CS_8 <= '1';
          DRM_BUS_MASTER_O_CYC <= S_DRM_BUS_MASTER_O_CYC;
          DRM_BUS_MASTER_O_WE <= S_DRM_BUS_MASTER_O_WE;
          DRM_BUS_MASTER_O_ADR <= S_DRM_BUS_MASTER_O_ADR(C_DRM_BUS_ADR_LSB_SIZE-1 downto 0);
          DRM_BUS_MASTER_O_DAT <= S_DRM_BUS_MASTER_O_DAT;
        when SELECT_IP_9 =>
          DRM_BUS_MASTER_O_CS_9 <= '1';
          DRM_BUS_MASTER_O_CYC <= S_DRM_BUS_MASTER_O_CYC;
          DRM_BUS_MASTER_O_WE <= S_DRM_BUS_MASTER_O_WE;
          DRM_BUS_MASTER_O_ADR <= S_DRM_BUS_MASTER_O_ADR(C_DRM_BUS_ADR_LSB_SIZE-1 downto 0);
          DRM_BUS_MASTER_O_DAT <= S_DRM_BUS_MASTER_O_DAT;
