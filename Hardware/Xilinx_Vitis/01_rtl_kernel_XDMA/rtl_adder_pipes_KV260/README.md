...
+ Using the vanilla SDCard image provided by Xilinx and installing the application using RPM repository

## 4.1. Generate the SDCard image with petalinux
### 4.1.1. Generate SDCard Image:
```bash
...
## 4.2. Use the vanilla SDCard image provided by Xilinx
